export default {
  titulo: `
    Lo que tienes que saber de la rotura de equipos electrónicos y maquinaria
  `,
  descripcion: `
    <p>
      Sabemos que este tipo de partes de rotura de equipos electrónicos y
      maquinaria pueden ocasionar muchas molestias en tu negocio por lo que
  ...
  proceso: [
    ...
    },
    {
      ...
      contenido: `
        <p>
          Es habitual disponer de un servicio de asistencia técnica que es
          quien se encarga del mantenimiento técnico del aparato o la máquina.
          En ese caso es posible que te solicitemos presupuesto e informe de tu
        ...
        <p>
          ...
          te solicitaremos el número de incidencia que hayas abierto  y el
          número de contrato de suministro para su posterior reclamación.
        </p>
      `,
    },
    {
