export default {
  titulo: 'Jakin beharrekoa',
  descripcion: `
    <p>
      Badakigu era honetako kalte-parteek eragozpen ugari sor ditzaketela zure negozioan,
  ...
  proceso: [
    ...
    },
    {
      ...
      respuesta: `
        Sí, en todas en las modalidades excepto la básica, Nahiago baduzu, konfiantzazko
    ...
    },
    {
      ...
      respuesta: `
        Ez kezkatu, perituak kalteen kausa zure negozioko hoditeria batean dagoela
        egiaztatu ondoren, eragindakoarekin harremanetan jarriko gara izandako
        kalteengatik kalte-ordaina emateko edo kalte horiek konpontzeko. Kaltetuak bere
        aseguru-etxeari partea ematen badio, haren erantzuna jaso arte itxarongo dugu
        akordioa lortzeko.
      `,
    },
    {
    ...
    },
    {
      ...
      contenido: `
        ...
        emango da espedientearen kudeaketa.
      `,
    },
    {
      tipo: 'faq',
    ...
    },
    {
      ...
      contenido: `
        ...
        gorabeherarekin lotutako gestioak egiten jarraitu behar izatea, eragileari
        erreklamatzeko nahiz hirugarren kaltetuei kalte-ordaina emateko.
