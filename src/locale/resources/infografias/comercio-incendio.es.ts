export default {
  titulo: 'Lo que tienes que saber de daños por incendio',
  descripcion: `
    <p>
      Sabemos que este tipo de partes pueden ocasionar muchas molestias en tu
  ...
  proceso: [
    ...
    },
    {
      ...
      contenido: `
        <p>
          ...
          enviarte un reparador  en menos de 3h que  se encargará de solucionar
          la urgencia.
        </p>
        <p>
    ...
    },
    {
      ...
      contenido: `
        En algunas ocasiones, tras solucionar los daños de tu negocio, podremos
        continuar realizando gestiones relacionadas con la incidencia, bien de
        reclamación al causante, bien para proceder a la indemnización de
