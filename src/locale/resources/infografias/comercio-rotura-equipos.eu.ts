export default {
  titulo: `Ekipamendu elektronikoak eta makineria hausteari buruz jakin beharrekoa`,
  descripcion: `
    <p>
      Badakigu ekipamendu elektroniko eta makineria haustearen parte hauek eragozpen ugari
      sor ditzaketela zure negozioan, eta horregatik ahal bezain laster konpontzen saiatuko
      gara
    </p>
    <p>
